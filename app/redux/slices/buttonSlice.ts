...
const buttonSlice = createSlice({
    ...
    reducers: {
        ...
        resetButtonState: (state, action: PayloadAction<ButtonState>) => {
            return action.payload;
        },
    },
});

export const { setBtnThickness, setBtnBroderStyle, setBorderRadius, setBorderColor, setBtnConstrastColor, setBtnHorizontalOffset, setBtnVerticalOffset, setBtnBlur, setBtnShadowColor,resetButtonState } = buttonSlice.actions;
