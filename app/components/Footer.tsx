          ...
          <div className="grid grid-cols-2">
            <div className={`space-y-5 ${visible2 ? 'block' : 'hidden'}`}>
              ...
              <ul className="text-black pl-0.5 flex flex-col gap-y-2">
                {storeSocialMedia[0] && <li className="hover:text-blue-950"><a className="flex items-center gap-1 hover:scale-105 duration-300  ease-linear"  href={storeSocialMedia[0].startsWith("http") ? storeSocialMedia[0] : `https://${storeSocialMedia[0]}`}><FaFacebook />Facebook</a></li>}
                {storeSocialMedia[1] && <li className="hover:text-blue-950"><a className="flex items-center gap-1 hover:scale-105 duration-300  ease-linear" href={storeSocialMedia[1].startsWith('http') ? storeSocialMedia[1] : `https://${storeSocialMedia[1]}`}><FaWhatsapp />Whatsapp</a></li>}
                {storeSocialMedia[2] && <li className="hover:text-blue-950"><a className="flex items-center gap-1 hover:scale-105 duration-300  ease-linear" href={storeSocialMedia[2].startsWith('http') ? storeSocialMedia[2] : `https://${storeSocialMedia[2]}`}><FaInstagram />Instagram</a></li>}
                {storeSocialMedia[3] && <li className="hover:text-blue-950"><a className="flex items-center gap-1 hover:scale-105 duration-300  ease-linear" href={storeSocialMedia[3].startsWith('http') ? storeSocialMedia[3] : `https://${storeSocialMedia[3]}`}><FaPinterest />Pinterest</a></li>}
                {storeSocialMedia[4] && <li className="hover:text-blue-950"><a className="flex items-center gap-1 hover:scale-105 duration-300  ease-linear" href={storeSocialMedia[4].startsWith('http') ? storeSocialMedia[4] : `https://${storeSocialMedia[4]}`}><FaXTwitter />Twitter</a></li>}
              </ul>
            </div>
            <div className={`flex gap-2 ${visible3 ? 'block' : 'hidden'}`}>
              <div className="w-11 h-11  text-black p-[1px] rounded-md hover:scale-110 duration-300  ease-linear">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
                  strokeWidth="0"
